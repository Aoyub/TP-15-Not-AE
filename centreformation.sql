...
--
-- Hôte : localhost
-- Généré le : ven. 21 nov. 2025 à 13:14
...
--
ALTER TABLE `formation`
  ADD CONSTRAINT `formation_ibfk_1` FOREIGN KEY (`id_formation`) REFERENCES `inscription` (`id_formation`);
...
ALTER TABLE `inscription`
  ...
  ADD CONSTRAINT `inscription_ibfk_2` FOREIGN KEY (`id_formation`) REFERENCES `module` (`id_formation`);
COMMIT;
